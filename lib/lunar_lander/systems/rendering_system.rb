...
class RenderingSystem < System
  def process_one_game_tick(entity_mgr, container, graphics)
    entities = entity_mgr.get_all_entities_possessing_component_of_type(Renderable)
    ...
    entities = entity_mgr.get_all_entities_possessing_component_of_type(Fuel)
    ...
    entities = entity_mgr.get_all_entities_possessing_component_of_type(PolygonCollidable)
    entities.each_with_index do |e, index|
